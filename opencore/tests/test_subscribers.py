...
class TestPostorder(unittest.TestCase):
    ...
    def _callFUT(self, node):
        from opencore.subscribers import postorder
...
class TestIndexContent(unittest.TestCase):
    ...
    def _callFUT(self, object, event):
        from opencore.subscribers import index_content
...
class TestUnindexContent(unittest.TestCase):
    ...
    def _callFUT(self, object, docids):
        from opencore.subscribers import unindex_content
...
class TestCleanupContentTags(unittest.TestCase):
    ...
    def _callFUT(self, object, docids):
        from opencore.subscribers import cleanup_content_tags
...
class TestHandleContentRemoved(unittest.TestCase):
    ...
    def _callFUT(self, object, event):
        from opencore.subscribers import handle_content_removed
...
class TestReindexContent(unittest.TestCase):
    ...
    def _callFUT(self, object, event):
        from opencore.subscribers import reindex_content
...
class _NOW_replacer:
    ...
    def _set_NOW(self, when):
        import opencore.subscribers as MUT
...
class Test_set_modified(unittest.TestCase,
    ...
    def _callFUT(self, object, event):
        from opencore.subscribers import set_modified
...
class Test_set_created(unittest.TestCase,
    ...
    def _callFUT(self, object, event):
        from opencore.subscribers import set_created
...
class TestDeleteCommunity(unittest.TestCase):
    ...
    def _callFUT(self, object, event):
        from opencore.subscribers import delete_community
...
class Test_add_mailinglist(MLBase, unittest.TestCase):
    def _callFUT(self, obj, event):
        from opencore.subscribers import add_mailinglist
...
class Test_remove_mailinglist(MLBase, unittest.TestCase):
    def _callFUT(self, obj, event):
        from opencore.subscribers import remove_mailinglist
...
class ProfileAddedTests(unittest.TestCase):
    ...
    def _callFUT(self, object, event):
        from opencore.subscribers import profile_added
        return profile_added(object, event)

    def test_event_new(self):
        from opencore.profile import CaseInsensitiveOOBTree
...
class ProfileRemovedTests(unittest.TestCase):
    ...
    def _callFUT(self, object, event):
        from opencore.subscribers import profile_removed
...
class QueryLoggerTests(unittest.TestCase):
    ...
    def _makeOne(self):
        from opencore.subscribers import QueryLogger
        return QueryLogger()
