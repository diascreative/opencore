...
class CommunityRootFolderTests(unittest.TestCase):
    ...
    def _getTargetClass(self):
        from opencore.content.models.files import CommunityRootFolder
    ...
    def test_class_conforms_to_ICommunityRootFolder(self):
        ...
        from opencore.content.interfaces import ICommunityRootFolder
...
class CommunityFolderTests(unittest.TestCase):
    ...
    def _getTargetClass(self):
        from opencore.content.models.files import CommunityFolder
    ...
    def test_class_conforms_to_ICommunityFolder(self):
        from zope.interface.verify import verifyClass
        from opencore.content.interfaces import ICommunityFolder
...
class CommunityFileTests(unittest.TestCase):
    ...
    def _getTargetClass(self):
        from opencore.content.models.files import CommunityFile
    ...
    def test_jpg(self):
        ...
        stream = resource_stream('opencore.content.models.tests', 'test.jpg')
...
class TestThumbnail(unittest.TestCase):
    def _getTargetClass(self):
        from opencore.content.models.files import Thumbnail
        return Thumbnail
    ...
    def _makeOne(self, pil_img=None, size=(200, 200)):
        if pil_img is None:
            ...
            img_file = pkg_resources.resource_stream(
                'opencore.content.models.tests', 'test.jpg'
            )
            import PIL.Image
...
class TestFilesToolFactory(unittest.TestCase):
    ...
    def _makeOne(self):
        from opencore.content.models.files import files_tool_factory
