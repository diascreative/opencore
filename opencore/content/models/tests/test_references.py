...
class OrderingTests(unittest.TestCase):
    ...
    def _getTargetClass(self):
        from opencore.content.models.references import Ordering
        return Ordering
    ...
    def test_class_conforms_to_IOrdering(self):
        ...
        from opencore.content.interfaces import IOrdering
...
class ReferenceSectionTests(unittest.TestCase):
    ...
    def _getTargetClass(self):
        from opencore.content.models.references import ReferenceSection
    ...
    def test_class_conforms_to_IReferenceSection(self):
        from zope.interface.verify import verifyClass
        from opencore.content.interfaces import IReferenceSection
...
class ReferenceManualTests(unittest.TestCase):
    ...
    def _getTargetClass(self):
        from opencore.content.models.references import ReferenceManual
    ...
    def test_class_conforms_to_IReferenceManual(self):
        from zope.interface.verify import verifyClass
        from opencore.content.interfaces import IReferenceManual
